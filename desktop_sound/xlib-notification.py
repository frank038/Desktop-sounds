            ...
            for ii in window_added:
                ...
                if prop:
                    ...
                    #     continue
                        ...
                        continue
                    elif self.display.intern_atom('_NET_WM_WINDOW_TYPE_NORMAL') in prop.value.tolist() or self.display.intern_atom('_NET_WM_WINDOW_TYPE_DIALOG') in prop.value.tolist():
                        # 
                        win_name_t = None
                        try:
